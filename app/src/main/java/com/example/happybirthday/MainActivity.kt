...
// CTRL + ALT + I == Auto Indent Code highlight all and do it
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        //BirthdayGreetingWithText( "Happy Birthday Debbie!", "- from Rodrigo")
        BirthdayGreetingWithImage("Happy Birthday Debbie!", "- from Rodrigo")
